...
const SignupPage: React.FC = () => {
  ...
  const handleGoogleError = () => {
    ...
    setError('Google sign-up failed. Please check your Google account settings.');
  };
  ...
  const SignupForm = () => (
    <>
      ...
      <div className="text-center mb-8 lg:hidden">
        ...
        />
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Sign Up for Notes</h1>
        <p className="text-gray-600">Create your account to start taking notes</p>
      </div>
        ...
        <div className="hidden lg:flex min-h-screen items-center">
          ...
          <div className="w-1/2 pr-8">
            <div className="text-center">
              ...
              />
              <h1 className="text-4xl font-bold text-gray-900 mb-4">Sign Up for Notes</h1>
              <p className="text-xl text-gray-600 mb-8">Your personal note-taking solution - Create your account</p>
